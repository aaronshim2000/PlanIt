  ...
  public String getPosts(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    try (Connection connection = dataSource.getConnection()) {
      ...
      while (rs.next())
      {
		...
		text_mediaTypes.add(rs.getString("mediaType"));
		text_imagesNums.add(rs.getString("imagesNum"));
		text_image00s.add(rs.getString("image00"));
		text_image01s.add(rs.getString("image01"));
		text_image02s.add(rs.getString("image02"));
		text_image03s.add(rs.getString("image03"));
		text_image04s.add(rs.getString("image04"));
		text_image05s.add(rs.getString("image05"));
		text_image06s.add(rs.getString("image06"));
		text_image07s.add(rs.getString("image07"));
		text_image08s.add(rs.getString("image08"));
		text_image09s.add(rs.getString("image09"));
		text_video00s.add(rs.getString("video00"));
      }
